...
class Ui_Scanner(object):
    def setupUi(self, Scanner):
        ...
        self.queueClear_Button = QtWidgets.QPushButton(self.centralwidget)
        self.queueClear_Button.setEnabled(False)
        self.queueClear_Button.setMinimumSize(QtCore.QSize(0, 30))
        self.queueClear_Button.setObjectName("queueClear_Button")
        self.gridLayout_6.addWidget(self.queueClear_Button, 1, 3, 1, 1)
        ...
        self.ref_plot.setMinimumSize(QtCore.QSize(537, 423))
        ...
        self.selectImage_Button = QtWidgets.QComboBox(self.centralwidget)
        self.selectImage_Button.setObjectName("selectImage_Button")
        self.selectImage_Button.addItem("")
        ...
        Scanner.setTabOrder(self.queueModify_Button, self.queueClear_Button)
        Scanner.setTabOrder(self.queueClear_Button, self.scan_mode)
    ...
    def retranslateUi(self, Scanner):
        ...
        self.queueClear_Button.setToolTip(_translate("Scanner", "<html><head/><body><p>Skip current measurement, and jump to next measurement in queue</p></body></html>"))
        self.queueClear_Button.setText(_translate("Scanner", "Scan Next"))
...
"Make no two axis have same value."))
        ...
        self.selectImage_Button.setItemText(0, _translate("Scanner", "Select Image"))
