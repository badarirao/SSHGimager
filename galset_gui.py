...
class Ui_galvanoForm(object):
    def galset_setupUi(self, Form, grp):
        ...
        self.p = Parameter.create(
            name='Galvanometer Settings', type='group', children=grp)
    ...
    def galset_retranslateUi(self, Form):
        ...
        self.defaultButton.setToolTip(_translate(
            "Form", "Restores all values to their default values"))
        self.defaultButton.setText(_translate("Form", "Restore Defaults"))
        self.setdefaultButton.setToolTip(_translate(
            "Form", "Sets these values as default. Use with caution!"))
        self.setdefaultButton.setText(_translate("Form", "Set as Default"))
        self.okayButton.setToolTip(_translate(
            "Form", "Accept and save the modified values, and quit the menu"))
        self.okayButton.setText(_translate("Form", "Okay"))
        self.cancelButton.setToolTip(_translate(
            "Form", "Cancel any changes made, and quit the menu"))
...
if __name__ == "__main__":
    ...
    grp = [
        {'name': 'X-axis settings', 'type': 'group', 'children': [
            ...
            {'name': 'Max speed', 'type': 'int',
                'value': 1, 'suffix': 'pulses per second'},
            {'name': 'Current speed', 'type': 'int',
                'value': 1, 'suffix': 'pulses per second'},
